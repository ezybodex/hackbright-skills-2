...
console.log(pizza.popularity); // This logs the popularity of the pizza
...
const { price } = pizza; // Destructure the price off the pizza object
console.log(price); // Log the value of the new price variable
...
const highRatedFood = filterByProperty("rating", 4.5);
console.log(highRatedFood);
