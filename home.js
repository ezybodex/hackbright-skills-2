...
function canWeDeliver(zipCode) {
  ...
  // Example usage:
  console.log(canWeDeliver(84606)); // This returns "Sorry, we can't deliver to that address"
  console.log(canWeDeliver(85205)); // This returns "You're in our delivery zone!"
